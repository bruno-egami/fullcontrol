...
priming_inicial_qtd = 5.0           # mm de purga inicial para carregar o bico
priming_inicial_vel = 100           # mm/min (velocidade de purga inicial)

# Perímetro - Início (Start)
priming_inicio_perimetro = True     # Habilita purga no início dos perímetros
priming_perimetro_inicio_qtd = 5.0  # mm de purga no início do perímetro
priming_perimetro_inicio_vel = 100  # mm/min

# Perímetro - Fim (End/Retraction)
priming_fim_perimetro = True        # Habilita alívio/retração no final dos perímetros
priming_perimetro_fim_qtd = 1.0     # mm de extrusão no fim do perímetro (negativo para retração)
priming_perimetro_fim_vel = 100     # mm/min

# Infill - Início (Start)
priming_inicio_infill = True        # Habilita purga no início do infill
priming_infill_inicio_qtd = 5.0     # mm de purga no início do infill
priming_infill_inicio_vel = 100     # mm/min

# Infill - Fim (End/Retraction)
priming_fim_infill = True           # Habilita alívio/retração no final do infill
priming_infill_fim_qtd = 5.0        # mm de extrusão no fim do infill (negativo para retração)
priming_infill_fim_vel = 100        # mm/min
